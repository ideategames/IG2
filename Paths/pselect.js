...
dispatchGame = function() {
	// for now, same code
	var selpath = (DMMlevel == 1) ? 'paths' : 'paths'
...
var pathsSelect = {
	...
	preload : function() {
	    ...
	    if (qs('pwd')=="sn00ker") {IGisPublic=false}
		DMMSetTopics()
...
//	    console.log("in entry create")
  ...
  //   		wordWrapWidth: instrWidth };
		...
		IGaddDivText({xloc:MIDX, yloc:ry(50),text:"Paths",size:32, color:"#fff",weight:300})
